...
const Staffs = () => {
    ...
    const createStaff = async () => {
        if (staff.firstName === "") {
            setStaffMsg({firstName: 'First name is required.'});
        } else if (staff.lastName === "") {
            setStaffMsg({lastName: 'Last name is required.'});
        } else if (staff.email === "" || !staff.email.includes("@")) {
            setStaffMsg({email: 'Valid email is required.'});
        } else if (staff.password === "") {
            setStaffMsg({password: 'Password is required.'});
        } else {
            staff.role = 1;
            staff.isPaid = true;
            staff.status = true;
                ...
                <Modal.Body>
                    <Form>
                        <div className="input-staffs">
                            ...
                            <p className="invalid-feedback d-block">{staffMsg.firstName}</p>
                        </div>
                        <div className="input-staffs">
                            <InputGroup className="mb-3">
                                <InputGroup.Text style={{width: 40}}><i className="fa fa-user"></i></InputGroup.Text>
                            ...
                            <div className="invalid-feedback d-block">{staffMsg.lastName}</div>
                        </div>
                        <div className="input-staffs">
                            <InputGroup className="mb-3">
                            ...
                            <div className="invalid-feedback d-block">{staffMsg.email}</div>
                        </div>
                        <div className="input-staffs">
                            <InputGroup className="mb-3">
                            ...
                            <div className="invalid-feedback d-block">{staffMsg.password}</div>
                        </div>
                        <Form.Group>
